...
public class TaskWebControllerE2E { // NOSONAR not a standard testcase name
	...
	public void testDeleteTask() throws JSONException {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("tasks_table")));
		assertThat(driver.findElement(By.id("tasks_table")).getText()).doesNotContain(id, "title to del",
				"descr to del");
	}
